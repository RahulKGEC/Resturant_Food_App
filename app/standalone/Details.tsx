            ...
            <ScrollView>
                <View style={{ marginHorizontal: 18 }}>
                    ...
                    <View style={{ alignItems: "center" }}>
                        <View style={{ height: 170, width: "100%", backgroundColor: "#FFB869", borderRadius: 23, marginVertical: 15, alignItems: "center" }}>


                            <Image source={{ uri: "https://clipartspub.com/images/pizza-clipart-clip-art-7.jpg" }} style={{ height: 150, width: 150, position: "absolute", top: -15, }} />
                    ...
                    <View style={{ flexDirection: "row", alignItems: "center", gap: 14, marginVertical: 18 }}>
                        <Text>SIZE :</Text>
